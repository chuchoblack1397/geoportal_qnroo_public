...
?>
        ...
        <body class="d-flex flex-column h-100">
                ...
                <div class="card">
                    <div class="row no-gutters">
                        <div class="col-md-2">
                            ...
                            <button type="button" class="btn btn-info ml-4 mb-1 mt-0" data-toggle="modal" data-target="#modal_subir_fotoGeo">Subir imagen</button>
                        </div>
                        <!--fin col-->
                        <div class="col-md-7">
            ...
            <div class="container bg-white p-3 pb-5">
                <!--mapa-->
                <div class="row">
                    <!--row-->
                    <div class="col-md-8">

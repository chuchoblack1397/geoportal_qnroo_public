...
<html lang="es">
  ...
  <body>
    ...
    <div class="container my-5 bg-light py-5 px-5 contLogin" style="width:25%;">
            <center>
              <img src="img/images.jpg" alt="" class="mb-4" style="width:100%">
            </center>
            <center>
                <h4>Geoportal <br> Big Data Geo Street</h4>
            </center>
            <br>

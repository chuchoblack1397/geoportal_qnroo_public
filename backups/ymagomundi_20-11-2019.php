...
<span class="icon-cross"></span>
  ...
  <div id="contendorControles" >
     ...
     <button class="accordion">Archivo</button>
					        ...
					        <li id="<?php echo $campo['idCapa'];?>">
                                      <div class="custom-control custom-checkbox">
                                        ...
                                        <label for="chk_<?php echo $campo['idCapa'];?>" class="custom-control-label"><?php echo $campo['tituloCapa'];?></label><br>
                                            ...
                                            <label class="form-check-label small icon-eye" for="chk_leyenda_<?php echo $campo['idCapa'];?>" title="Ver Leyenda"></label>
                                            <label class="form-check-label small icon-pencil2" title="Editar capa"></label>
                                            <label class="form-check-label small icon-bin" title="Borrar capa"></label>
                                      </div>
...
<?php
 foreach ($arregloCapas as $clave => $campo) {//obteniendo datos de Arreglo con datos de BD
?>
    var chkBotonControlLeyenda_<?php echo $campo['idCapa'];?> = document.getElementById('chk_<?php echo $campo['idCapa'];?>');
    chkBotonControlLeyenda_<?php echo $campo['idCapa'];?>.addEventListener("change", mostrarLeyendas, false);
<?php
}
?>
...
function subFuncionactivarInformacion(){

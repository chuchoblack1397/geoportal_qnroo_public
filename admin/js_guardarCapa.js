...
btn_guardarCapa.onclick = function (e) {
    ...
    var transparenciaCapa = document.getElementById('transparenciaCapa')
        .checked;
    ...
    if (tituloCapa != '' && urlCapa != '' && capaCapa != '') {
...
function quitarAcentos(cadena) {
    ...
    var exprQuitar = /[áàéèíìóòúùñ]/gi;
    var resQuitar = cadena.replace(exprQuitar, function (e) {
        return charsQuitar[e];
    });
    return resQuitar;
}

function reemplazarAcentosHTML(cadena) {
    //funcion POSIBLE!!!! NO ESTOY EJECUTANDOLA
    var charsReemplazar = {
        á: '&aacute;',
        é: '&eacute;',
        í: '&iacute;',
    ...
    var exprReemplazar = /[áàéèíìóòúùñ]/gi;
    var resReemplazar = cadena.replace(exprReemplazar, function (e) {
        return charsReemplazar[e];
    });

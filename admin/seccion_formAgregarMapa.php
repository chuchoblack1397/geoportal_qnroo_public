 <form id="formAgregarCapa">
                      <h3>
                        ...
                        <div class="form-group row">
                          <label for="tituloCapa" class="col-sm-2 col-form-label">Título del Mapa</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="tituloCapa" placeholder="Título del mapa" required>
                          </div>
                        </div>
                        <div class="form-group row">

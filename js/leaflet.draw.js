    ...
    (L.drawVersion = "0.4.10"),
        ...
        (L.drawLocal = {
            draw: {
                toolbar: {
                    ...
                    finish: { title: "Terminar dibujo", text: "Finalizar" },
                    undo: { title: "Eliminar último punto dibujado", text: "Eliminar último punto" },
                    buttons: { polyline: "Dibujar polilínea", polygon: "Dibujar un polígono", rectangle: "Dibujar un rectángulo", circle: "Dibujar un circulo", marker: "Dibujar un marcador" },
                },
                handlers: {
                    circle: { tooltip: { start: "Haz clic y arrastra para dibujar el círculo." }, radius: "Radius" },
                    marker: { tooltip: { start: "Haga clic en el mapa para colocar el marcador." } },
                    polygon: { tooltip: { start: "Haga clic para comenzar a dibujar la forma.", cont: "Haga clic para continuar dibujando la forma.", end: "Haga clic en el primer punto para cerrar esta forma." } },
                    polyline: { error: "<strong>Error:</strong>los bordes de la forma no pueden cruzarse!", tooltip: { start: "Haga clic para comenzar a dibujar la línea.", cont: "Haga clic para continuar dibujando la línea.", end: "Haga clic en el último punto para terminar la línea." } },
                    rectangle: { tooltip: { start: "Haga clic y arrastre para dibujar un rectángulo." } },
                    simpleshape: { tooltip: { end: "Suelte el mouse para terminar de dibujar." } },
                },
            },
            edit: {
                toolbar: {
                    actions: { save: { title: "Guardar cambios.", text: "Guardar" }, cancel: { title: "Cancelar edición, descartar todos los cambios.", text: "Cancelar" }, clearAll: { title: "borrar todas las capas.", text: "Borrar todo." } },
                    buttons: { edit: "Editar capas.", editDisabled: "No hay capas para editar.", remove: "Eliminar capas.", removeDisabled: "No hay capas para eliminar." },
                },
                handlers: { edit: { tooltip: { text: "Arrastre los controladores o el marcador para editar la función.", subtext: "Haga clic en cancelar para deshacer los cambios." } }, remove: { tooltip: { text: "Haga clic en una función para eliminar" } } },
            },
        }),
        (L.Draw.Event = {}),
        ...
        (L.Draw.Polyline = L.Draw.Feature.extend({
            ...
            _getMeasurementString: function () {
                ...
                return (
                    (t = i && e && e.distanceTo ? this._measurementRunningTotal + e.distanceTo(i) : this._measurementRunningTotal || 0),
        ...
        (L.Draw.Rectangle = L.Draw.SimpleShape.extend({
            ...
            _getTooltipText: function () {
                ...
                return (
                    n && ((t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs()), (e = L.GeometryUtil.geodesicArea(t)), (i = s ? L.GeometryUtil.readableArea(e, this.options.metric) : "")),
        ...
        (L.Draw.Circle = L.Draw.SimpleShape.extend({
            ...
            _onMouseMove: function (t) {
                ...
                if ((this._tooltip.updatePosition(i), this._isDrawing)) {
                    ...
                    var s = "";
                    o && (s = L.drawLocal.draw.handlers.circle.radius + ": " + L.GeometryUtil.readableDistance(e, n, this.options.feet, this.options.nautic)), this._tooltip.updateContent({ text: this._endLabelText, subtext: s });
                }
            },
        })),
                    ...
                    return (
                        i
                            ? ((s = ["ha", "m"]),
                              ...
                              (n =
                                  e >= 1e6 && -1 !== s.indexOf("km")
                                      ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " km²"
                                      : e >= 1e4 && -1 !== s.indexOf("ha")
                                      ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha"
                                      : L.GeometryUtil.formattedNumber(e, o.m) + " m²"))
                            : ((e /= 0.836127),
                              (n = e >= 3097600 ? L.GeometryUtil.formattedNumber(e / 3097600, o.mi) + " mi²" : e >= 4840 ? L.GeometryUtil.formattedNumber(e / 4840, o.ac) + " acres" : L.GeometryUtil.formattedNumber(e, o.yd) + " yd²")),
                        n
                    );
                },
                readableDistance: function (e, i, o, n, s) {
                    ...
                    switch (i ? ("string" == typeof i ? i : "metric") : o ? "feet" : n ? "nauticalMile" : "yards") {
                        ...
                        case "feet":
                            ...
                            break;
                        case "nauticalMile":
                            (e *= 0.53996), (a = L.GeometryUtil.formattedNumber(e / 1e3, s.nm) + " nm");
                            break;
                        case "yards":
                        default:
        ...
        (L.Toolbar = L.Class.extend({
            ...
            _createActions: function (t) {
                ...
                for (var l = 0; l < r; l++)
                    ("enabled" in a[l] && !a[l].enabled) ||
                        ((e = L.DomUtil.create("li", "", s)),
                        (n = this._createButton({ title: a[l].title, text: a[l].text, container: e, callback: a[l].callback, context: a[l].context })),
        ...
        (L.EditToolbar = L.Toolbar.extend({
            ...
            getActions: function () {
                return [
                    ...
                    { title: L.drawLocal.edit.toolbar.actions.clearAll.title, text: L.drawLocal.edit.toolbar.actions.clearAll.text, callback: this._clearAllLayers, context: this },
                ];
            },
            addToolbar: function (t) {
